...
function Collection() {
  ...
  const applyFilter = () =>{
    ...
    if(category.length > 0){
      producsCopy = producsCopy.filter(item => category.includes(item.category))
    }

   if(subCategory.length > 0){
    producsCopy = producsCopy.filter(item=> subCategory.includes(item.subCategory))
   }


    setFilterProducts(producsCopy)
  }
